...
| [news search tools](/examples/code_mcp_servers/news_search_tools/) | Web search tools for finding news from NYT, Reddit, DuckDuckGo, and Yahoo Finance. |
...
| [news source](/examples/custom_sources/news_source/) | Parameterized news source that fetches from NYT, Reddit, and Yahoo Finance for a configurable news domain. |
| [NYT front page source](/examples/custom_sources/nyt_front_page_source/) | Fetches daily headlines from all 26 NYT Top Stories sections. |
