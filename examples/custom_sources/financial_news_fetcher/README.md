...
This folder contains a SAS Retrieval Agent Manager (RAM) custom source example that fetches recent technology-sector financial news, builds a daily PDF digest, and writes the PDF file to the configured RAM source.
...
The file is then uploaded to the RAM source through client.save_file.
